...
class SystemAdminPageWidget extends StatefulWidget {
  ...
  @override
  SystemAdminPageState createState() =>
      SystemAdminPageState(userName: userName);
}
...
class SystemAdminPageState extends State<SystemAdminPageWidget> {
  String pictureUrl =
      "https://all-psd.ru/uploads/posts/2011-05/psd-web-user-icons.jpg";
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text(
            'Страница системного администратора ' + userName,
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      'Список открытых проблемных запросов',
                      style: TextStyle(fontSize: 16, color: Colors.deepPurple),
                    ),
                  ),
